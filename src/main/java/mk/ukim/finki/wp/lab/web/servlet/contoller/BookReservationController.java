package mk.ukim.finki.wp.lab.web.servlet.contoller;
...
public class BookReservationController {
    ...
    public String postBookReservation(@RequestParam String bookTitle,
        ...
        model.addAttribute("clientIpAddress", request.getRemoteAddr());
        model.addAttribute("numCopies", bookReservation.getNumberOfCopies());
